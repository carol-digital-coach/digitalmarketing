                        ...
                        <div className="flex space-x-6">
                            {navigationItems.map((item) => (
                                <a
                                    key={item.name}
                                    href={item.href}
                                    className="text-sm font-medium uppercase tracking-widest text-white relative group transition-colors p-2 overflow-y-hidden hover:text-[var(--site-pink)]"
                                >
                                    {item.name}
                                    <span
                        ...
                        <div className="flex flex-col items-center space-y-8 w-full">
                            {navigationItems.map((item) => (
                                <a
                                    ...
                                    href={item.href}
                                    onClick={() => setIsOpen(false)}
                                    className="text-4xl font-black text-white uppercase transition-colors"

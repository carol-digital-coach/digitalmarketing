                        ...
                        {data?.data?.packages.map((pkg: any, index: any) => {
                            ...
                            return (
                                <ScrollFadeIn key={pkg.id} delay={index * 150} className={`h-full ${isFeatured ? 'p-6 lg:mt-5 mt-4 md:-mt-8 mb-4 md:mb-8' : 'p-6 lg:mt-5 mt-4 md:-mt-8 mb-4 md:mb-8'}`}>
                                    <div
                                        className={`relative p-8 rounded-3xl border-none hover:translate-y-5 flex flex-col overflow-hidden relative transition-all duration-500 h-full border group hover:border-pink-500/50 bg-[var(--site-black)]`}
                                    >
                                        {isFeatured && (
